...
import { IconChevR, IconDash } from '@/app/admin/_components/icons'
...
export default async function CategoriesDiagramPage() {
  ...
  return (
    <Shell active="categories" crumb={<>Content <IconChevR /> Categories <IconChevR /> Diagram</>} title="Category map"
      actions={<Link href="/admin/categories" className="btn btn--ghost btn--sm"><IconDash /> Back to list</Link>}>
